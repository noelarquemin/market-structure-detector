...
if ticker in st.session_state.history:
    ...
    st.subheader("Graphique de structure")
    fig = plot_market_structure(
        df, he,
    ...
    with st.expander("Voir les extrêmes détaillés d'un niveau"):
        ...
        st.dataframe(extremes_to_dataframe(he, lvl_choice), use_container_width=True)
else:
